...
export const SPOTWARE_OAUTH_AUTHORIZE_URL = 'https://openapi.ctrader.com/apps/auth';
export const SPOTWARE_OAUTH_TOKEN_URL = 'https://openapi.ctrader.com/apps/token';
