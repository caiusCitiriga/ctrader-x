...
export class SpotwareRateLimiter {
    private readonly fivePerSecond = new RateLimiter(FIVE_PER_SECOND_INTERVAL_MS);
    private readonly fiftyPerSecond = new RateLimiter(FIFTY_PER_SECOND_INTERVAL_MS);
